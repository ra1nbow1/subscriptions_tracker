...
function Subscriptions({
	...
	return (
		<>
					...
					{!isAddingNewSubscription ? (
						...
						<div className="bg-gray-800 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
							...
							<select
								...
								<option value="месяц" defaultValue={'месяц'}>
									Каждый месяц
								</option>
			...
			{alertIsOpened && (
				<div
					className="bg-red-100 text-red-700 w-52 py-3 px-2 text-center align-center flex justify-between rounded fixed bottom-5 right-5"
					role="alert">
					<span className="block sm:inline">Заполните все поля</span>
					<FontAwesomeIcon
						onClick={() => setAlertIsOpened(false)}
						icon={faClose}
						size="xl"
